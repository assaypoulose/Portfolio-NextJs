...
const Contact = () => {
  ...
  return (
    ...
    <div
      id='contact'
      className='w-full px-5 sm:px-10 md:px-[12%] py-10 scroll-mt-10 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-cover md:bg-[length:90%_auto]'
    >
      ...
      <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        ...
        <textarea
          ...
          required
          className='w-full p-4 outline-none border-[0.5px] border-gray-400 rounded-md bg-white dark:placeholder-gray-400'
          name='message'
        ></textarea>
        <button type='submit' className='py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/70 text-white border rounded-full mx-auto hover:bg-black duration-500'>
          Send now
        </button>
        <p className='mt-4'>
          {result}
