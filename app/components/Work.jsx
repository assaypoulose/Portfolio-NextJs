...
const Work = () => {
    return (
        <div id='work' className='w-full px-[12%] py-10 scroll-mt-10'>
            ...
            <a href='' className='w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full y-3 px-10 mx-auto my-20 lightHover duration-500'>
